    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="profile_update.php?return=<?php echo basename htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
